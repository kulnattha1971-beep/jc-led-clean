...
export const metadata: Metadata = {
  title: "เช่าจอ LED สัมมนา กรุงเทพ | รองรับ 50–2,000 คน",
      ...
      <main>
        <header className="py-16 px-4 text-center" style={{ background: "#111" }}>
          <div className="container-main" style={{ maxWidth: "720px" }}>
            ...
            <h1 className="text-4xl font-black text-white mb-4">เช่าจอ LED <span style={{ color: "#E8001D" }}>สัมมนา</span><br />กรุงเทพฯ</h1>
