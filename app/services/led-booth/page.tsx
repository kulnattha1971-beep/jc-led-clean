...
export const metadata: Metadata = {
  title: "จอ LED ออกบูธ นิทรรศการ กรุงเทพ | P3.9 45°",
      ...
      <main>
        <header className="py-16 px-4 text-center" style={{ background: "#111" }}>
          <div className="container-main" style={{ maxWidth: "720px" }}>
            ...
            <h1 className="text-4xl font-black text-white mb-4">เช่าจอ LED <span style={{ color: "#E8001D" }}>ออกบูธ / นิทรรศการ</span><br />กรุงเทพฯ</h1>
